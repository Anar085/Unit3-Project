...
|---------|---------------------------------------------------------------------------------------------------------------------|-----------------------------------------------------------------------------------------------------------------|---------------|------------------------|-----------|
| 1       | Planning-Write problem definition                                                                                   | Meet with client and finalize a description of the problem.                                                     | 30 min        | February 24            | A         |
| 2       | Planning-Suggest and finalize success criteria                                                                      | Meet with client and agree on success criteria for the POS solution.                                            | 30 min        | February 25            | A         |
| 3       | Planning-Write proposed solution                                                                                    | Finalize the success criteria and propose a solution for the POS system.                                        | 30 min        | February 25            | A         |
| 4       | Design-Create a system diagram and share it with client                                                             | To have a clear idea of the hardware and software  requirements for the proposal solution                       | 1 hour        | February 26            | B         |
| 5       | Design-Create UML and ER diagrams                                                                                   | Plan the backend structure of the POS app                                                                       | 2 hours       | February 27            | B         |
| 6       | Design-Create 3 flow diagrams: easy, medium, and hard in terms of development complexity                            | To have clear idea of development in non-coding language                                                        | 3 hours       | February 27            | B         |
| 7       | Design-Create a test plan                                                                                           | Make sure that there will be no challenge for my customer to test the app themselves                                                       | 2 hours       | February 28            | B         |
| 8       | Design-Give information about my data storing method- SQL Databases                                                 | To give description of the data format used                                                                     | 1 hour        | February 28            | B         |
| 9       | Development-Code basic screens and navigation                                                                       | Creating blank screens for all planned screens and linking them using ScreenManager                             | 1 hour        | March 1                | C         |
| 10      | Development-Create login and registration screen                                                                    | Making login and registration screens fully functional that they get user data from the database                | 2 hours       | March 2                | C         |
| 11      | Development-Code the layout of Inside and Terrace map of restaurant in Kivy                                         | Getting accurate digital map of restaurant                                                                      | 2 hours       | March 2                | C         |
| 12      | Development-Customize the circular and rectangular table buttons for better  visuality and more complex development | Getting rectangular and circular table buttons that can be touched,  put some text on, and color can be changed | 4 hours       | March 3                | C         |
| 13      | Development-Code Waiter Table screen in kivy file                                                                   | Getting waiter-friendly interface for better order taking                                                       | 2 hours       | March 4                | C         |
| 14      | Development-Code the Waiter Table class in python                                                                   | Getting fully functional waiter section: correct order management and table status update                       | 5 hours       | March 5                | C         |
| 15      | Development-Apply the same layout for the Admin Inside and Terrace except some admin special functionalities        | Get the same restaurant map for admins for real time and admin friendly table management                        | 30 min        | March 5                | C         |
| 16      | Development-Code Admin Available Table screen in kivy file                                                          | Getting admin-friendly interface for available tables                                                           | 1 hour        | March 6                | C         |
| 17      | Development-Code the Admin Available Table class in python                                                          | Getting appropriate available table screen based on the table touched                                           | 3 hours       | March 7                | C         |
