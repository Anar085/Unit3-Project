...
|---------|-------------------------------------------------------------------------------------------------------------------------------------------------|-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|------------|
| 1       | To ensure that users can log in with valid credentials and are directed  to the correct interface based on their role (Waiter or Administrator) | 1. Run the pos_system.py and enter valid waiter username and password 2. Press "Login" button 3. Press "Logout" button in waiter interface and enter valid admin username and password 4. Press "Login" button 5. Press "Logout" button in admin interface and enter invalid username and password 6. Press "Login" button                                                                                                                                                                                                                                                                                                                                                                                                                                      | 1. Verify that the user is redirected to  the Waiter interface after step 2 2. Verify that the user is redirected to  the Admin interface after step 4 3. Verify that the system gives error  message-"Invalid Credentials" after step 6                                                                                                                                                                                                                                                                                                                |            |
| 2       | To ensure waiters can create orders, add items with quantities, calculate  totals (including service charges and taxes), and print bills        | 1. Run the pos_system.py and enter valid waiter username and password 2. Press "Login" button 3. Press a random table 4. Press an item from menu section 5. Enter a valid quantity 6. Press "Print the bill" and verify its accuracy 7. Press "Out" icon and press same table again                                                                                                                                                                                                                                                                                                                                                                                                                                                                             | 1. Verify that Table Waiter screen is opened  for that special table after step 3 2. Verify that presses items are visible in  Ordered items section with price and quantity after  step 5 3. Verify the accuracy of the bill printed after step 6 4. Ensure that pre-ordered items are still shown in  Ordered items section after step 7                                                                                                                                                                                                              |            |
| 3       | To ensure that admins can cancel/finish orders, view ongoing orders, and update table statuses automatically.                                   | 1. Run the pos_system.py and enter valid admin username and password 2. Press "Login" button 3. Press the table with ongoing order, view its details (items, quantities, and total  costs), and press finish/cancel button. 4. Press the same table 5. Press the "out" icon, and then press the "Cash register/Ongoing Orders" button 6. Press the check button on the table and then press finish/cancel orders button  7. Press "Back" button and press the table checked on the data table                                                                                                                                                                                                                                                                   | 1. Verify that it is possible to see the ongoing order and  its details during step 3 2. Verify that screen is directed to Admin Inside after  step 3 3. Verify table status is now "Available" after step 4 4. Verify that data table screen is out after step 5 5. Verify that order in checked table is now finished/canceled after step 7                                                                                                                                                                                                           |            |
| 4       | Ensure user passwords are encrypted and all data (orders, users, tables)  is stored securely in an SQLite database.                             | 1. Run the pos_system.py and register a new user with a username and password. 2. Open the SQLite database (pos.db) and verify that the password is stored as a hash. 3. Log in as the new user, create an order, and add items to it. 4. Restart the app and log in again as the same user. 5. Navigate to the table where the order was created. 6. Check the database to ensure the order, user, and table data are stored permanently.                                                                                                                                                                                                                                                                                                                      | 1. Verify that the password is stored as a hash in  the database during step 2 2. Verify that the order history persists after  restarting the app during step 5 3. Verify that all data (orders, users, tables)  is stored permanently in the database during step 6                                                                                                                                                                                                                                                                                   |            |
| 5       | Verify that the app provides a touchable map of the restaurant  and clear navigation between screens.                                           | 1. Run the pos_system.py and log in as a waiter with valid credentials. 2. Press the "Login" button and verify that the screen is directed to the Waiter Inside/Terrace screen. 3. Use the touchable map to select a table and verify that the screen navigates to the table screen. 4. Press the "Back" button and verify that the screen returns to the Waiter Inside/Terrace screen. 5. Log out and log in as an admin with valid credentials. 6. Press the "Login" button and verify that the screen is directed to the Admin Inside/Terrace screen. 7. Use the touchable map to select a table and verify that the screen navigates to the table screen. 8. Press the "Back" button and verify that the screen returns to the Admin Inside/Terrace screen. | 1. Verify that the Waiter Inside/Terrace screen is displayed after step 2. 2. Verify that the table screen is displayed after selecting a table during step 3. 3. Verify that the Waiter Inside/Terrace screen is displayed after  pressing the "Back" button during step 4. 4. Verify that the Admin Inside/Terrace screen is displayed after step 6. 5. Verify that the table screen is displayed after selecting a table during step 7. 6. Verify that the Admin Inside/Terrace screen is displayed after  pressing the "Back" button during step 8. |            |
## Record of Tasks
